          ...
          <div key={index} className={styles['person-container']}>
            ...
            <div className={styles['person-details']}>
              ...
              <div className={styles['social-links']}>
                <a href={person.linkedIn} target="_blank" rel="noopener noreferrer"><i className="fab fa-linkedin"></i></a>
                <a href={person.github} target="_blank" rel="noopener noreferrer"><i className="fab fa-github"></i></a>
              </div>
            </div>
          </div>
        ))}
